...
function Image() {
  return (
    ...
    >
      <div className="w-110 small:w-95 sm:w-105 medium:w-100 h-full p-0.5 small:p-1 bg-primary/30 backdrop-blur-md justify-self-end rounded-xl rotate-10 small:rotate-2 sm:rotate-6 medium:rotate-2">
