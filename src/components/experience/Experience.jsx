...
function Experience() {
  return (
    <div id="experience" className="w-full h-full pt-18 px-4 md:px-20">
      ...
      <div className="w-full h-full flex flex-col midmedium:grid midmedium:grid-cols-3 items-center justify-between gap-10 midmedium:gap-20 px-4 md:px-0 midmedium:px-8">
