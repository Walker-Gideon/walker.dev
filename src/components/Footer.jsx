  ...
  return (
    <div className="w-full h-15 small:h-25 medium:h-15 px-8 py-6 sticky bottom-0 z-40 bg-white">
      <footer className="mb-5 flex small:flex-col medium:flex-row items-center justify-between small:gap-1.5">
        <div className="text-[1rem] medium:text-[1rem] small:text-lg medium:text-xl font-medium speial-font">
          <p>
        ...
        <div>
          <button className="flex itmes-center gap-1 text-[1rem] medium:text-[1rem] small:text-xl font-bold cursor-pointer transition-all duration-300 hover:gap-1.5">
